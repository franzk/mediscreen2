...
class RiskLevelDataServiceTest {
    ...
    void assessmentRiskLevelDtoTest() {
        ...
        // Act
        RiskLevelData result = serviceUnderTest.getRiskLevel(random.nextInt());
        // Arrange
    ...
    void calculateRiskLevel1argTest()  {
        ...
        testPatient.setSex(RandomString.make(64));
        when(patientProxy.getPatientById(anyInt())).thenReturn(testPatient);
        Mockito.doReturn(random.nextInt()).when(serviceUnderTest).calculateAge(any());
        // Act
